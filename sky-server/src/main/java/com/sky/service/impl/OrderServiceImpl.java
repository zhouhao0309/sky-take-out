...
public class OrderServiceImpl implements OrderService {
    ...
    public PageResult pageQuery4User(int pageNum, int pageSize, Integer status) {
        ...
        if (page != null && page.getTotal() > 0) {
            for (Orders orders : page) {
                ...
                // 查询订单明细
                List<OrderDetail> orderDetails = orderDetaliMapper.getByOrderId(orderId);
    ...
    public OrderVO details(Long id) {
        ...
        // 查询该订单对应的菜品/套餐明细
        List<OrderDetail> orderDetailList = orderDetaliMapper.getByOrderId(orders.getId());
...
//         根据订单id更新订单的状态、支付方式、支付状态、结账时间
    ...
    public void repetition(Long id) {
        ...
        // 根据订单id查询当前订单详情
        List<OrderDetail> orderDetailList = orderDetaliMapper.getByOrderId(id);
